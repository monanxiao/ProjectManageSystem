            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12"> 
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title am-fl">新增账单</div>
                    </div>
                    <div class="widget-body am-fr">
                        <form action="{{ route('bill.store') }}" class="am-form tpl-form-line-form" method="POST">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name='BillName' placeholder="请输入账单名称" data-role="tagsinput">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" name='earningTime' value="{{ date('Y-m-d H:i:s') }}" id="my-start-2">
                                    @error('earningTime')
                                        <div class="am-alert am-alert-danger am-u-sm-6" data-am-alert>
                                          <button type="button" class="am-close">&times;</button>
                                          <p>{{ $message }}</p>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" name='earningPrice' placeholder='0.00'>
                                    @error('earningPrice')
                                        <div class="am-alert am-alert-danger am-u-sm-6" data-am-alert>
                                          <button type="button" class="am-close">&times;</button>
                                          <p>{{ $message }}</p>
                                ...
                                <div class="am-u-sm-9">
                                    <select  name='server_id' >
                                        ...
                                        @foreach($server as $sv)
                                            <option value="{{ $sv->id }}">服务--{{ $sv->serverName }}</option>
                                        @endforeach
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <textarea class="" name="earningAnnotation" rows="10" id="user-intro" placeholder="请输入文章内容"></textarea>
                                </div>
                            </div>
